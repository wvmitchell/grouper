...
class GroupTest < MiniTest::Test
  ...
  #def test_teams_of_returns_the_teams
  #  teams = group.teams_of(2)
  #  assert_equal [['Will', 'Logan'],['Eric', 'Layla']], teams
  #end
  ...
  def test_group_can_be_divided_into_teams
    group = Grouper::Group.new
    group.members = %w{one two three four five six seven eight nine ten}
    assert_equal [%w{one two three}, %w{four five six}, %w{seven eight nine ten}], group.teams_of(3,group.members)
  end
